       ...
       double *anw, double *phi, double *q) {
        ...
        int row_last = (n[0]-1) * STRIDE_I + 1;
            ...
            for (int j = 1; j < n[1]-1; j++) {
                ...
                bn[row_base] = (an[row_base] + alp*anw[row_base] - alp*bw[row_base]*bn[row_inn] - 
                        bw[row_base]*bne[row_inn]) / bp[row_base];
                
                be[row_base] = (ae[row_base] + alp*ase[row_base] - alp*bs[row_base]*be[row_base - 1] - 
                        bs[row_base]*bne[row_base - 1]) / bp[row_base];
                
                bne[row_base] = ane[row_base] / bp[row_base];
                ...
                if (i == 0) {
                    ...
                    bse[row_last] = bse[row_base];
                    bnw[row_last] = bnw[row_base];
        ...
        double ssum = 0.0;
            ...
            for (int i = 0; i < n[0]-1; i++) {
                ...
                for (int j = 1; j < n[1]-1; j++) {
                    // Compute residual using offsets
                    res[row_base] = q[row_base] - ap[row_base]*phi[row_base] - 
                    ...
                    ssum += fabs(res[row_base]);
                    
                    // Forward substitution
                    qp[row_base] = (res[row_base] - bs[row_base]*qp[row_base - 1] - 
                            bw[row_base]*qp[row_inn] - bsw[row_base]*qp[row_inn - 1]) / bp[row_base];
                    
                    // Handle periodic boundary
                    if (i == 0) {
                        res[row_last] = res[row_base];
            ...
            for (int i = n[0]-2; i >= 0; i--) {
                ...
                for (int j = n[1]-2; j >= 1; j--) {
                    ...
                    phi[row_base] = phi[row_base] + del[row_base];
                    
                    // Handle periodic boundary
                    if (i == 0) {
                        phi[(n[0]-1)*STRIDE_I + j] = phi[row_base];
                    }
        ...
        delete[] bp; delete[] res; delete[] qp; delete[] del; delete[] phio;
    }
        ...
        for (int iter = 0; iter < maxiter; iter++) {
                ...
                for (int j = 1; j < n[1]-1; j++) {
                    ...
                    if (j == 1 || j == n[1]-2) {
                        ...
                        res[row_base] = q[row_base] - ap[row_base]*phi[row_base] - 
                                ...
                                anw[row_base]*phi[row_inn + 1] - ane[row_base]*phi[row_ipp + 1] - 
                                asw[row_base]*phi[row_inn - 1] - ase[row_base]*phi[row_ipp - 1] - 
                                aee[row_base]*phi[row_ipp2] - aww[row_base]*phi[row_inn2] - 
                                annee[row_base]*phi[row_ipp2 + 2] - anee[row_base]*phi[row_ipp2 + 1] - 
                                asee[row_base]*phi[row_ipp2 - 1] - assee[row_base]*phi[row_ipp2 - 2] - 
                                anne[row_base]*phi[row_ipp + 2] - asse[row_base]*phi[row_ipp - 2] - 
                                annw[row_base]*phi[row_inn + 2] - assw[row_base]*phi[row_inn - 2] - 
                                annww[row_base]*phi[row_inn2 + 2] - anww[row_base]*phi[row_inn2 + 1] - 
                                asww[row_base]*phi[row_inn2 - 1] - assww[row_base]*phi[row_inn2 - 2] - 
                                ann[row_base]*phi[row_base + 2] - ass[row_base]*phi[row_base - 2];
                    }
            ...
            for (int i = 0; i < n[0]-1; i++) {
                ...
                for (int j = 1; j < n[1]-1; j++) {
                    ...
                    if (j == 1 || j == n[1]-2) {
                        // Second order stencil
                        phi[row_base] = (q[row_base] - ae[row_base]*phi[row_ipp] - 
                                an[row_base]*phi[row_base + 1] - as[row_base]*phi[row_base - 1] - 
                                aw[row_base]*phi[row_inn] - anw[row_base]*phi[row_inn + 1] - 
                                ane[row_base]*phi[row_ipp + 1] - asw[row_base]*phi[row_inn - 1] - 
                                ase[row_base]*phi[row_ipp - 1]) / ap[row_base];
                    } else {
                        // Fourth order stencil
                        phi[row_base] = (q[row_base] - ae[row_base]*phi[row_ipp] - 
                                an[row_base]*phi[row_base + 1] - as[row_base]*phi[row_base - 1] - 
                                aw[row_base]*phi[row_inn] - anw[row_base]*phi[row_inn + 1] - 
                                ane[row_base]*phi[row_ipp + 1] - asw[row_base]*phi[row_inn - 1] - 
                                ase[row_base]*phi[row_ipp - 1] - aee[row_base]*phi[row_ipp2] - 
                                aww[row_base]*phi[row_inn2] - annee[row_base]*phi[row_ipp2 + 2] - 
                                anee[row_base]*phi[row_ipp2 + 1] - asee[row_base]*phi[row_ipp2 - 1] - 
                                assee[row_base]*phi[row_ipp2 - 2] - anne[row_base]*phi[row_ipp + 2] - 
                                asse[row_base]*phi[row_ipp - 2] - annw[row_base]*phi[row_inn + 2] - 
                                assw[row_base]*phi[row_inn - 2] - annww[row_base]*phi[row_inn2 + 2] - 
                                anww[row_base]*phi[row_inn2 + 1] - asww[row_base]*phi[row_inn2 - 1] - 
                                assww[row_base]*phi[row_inn2 - 2] - ann[row_base]*phi[row_base + 2] - 
                                ass[row_base]*phi[row_base - 2]) / ap[row_base];
                    }
